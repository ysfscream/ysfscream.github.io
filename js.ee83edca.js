...
},{}],"js/intro.ts":[function(require,module,exports) {
"use strict";
...
},{}],"js/time.ts":[function(require,module,exports) {
"use strict";
...
exports["default"] = {
    ...
    progressOfYear: function progressOfYear() {
        ...
        timeDom.innerText = year.toString();
        var time = Date.parse(this.date);
        var lasttime = Date.parse(year + "-01-01");
        var day = (time - lasttime) / (1000 * 60 * 60 * 24);
        ...
        progressDom.value = percentYear.toString();
        percentDom.innerText = percentYear.toString();
    }
};
...
var darkmode_js_1 = __importDefault(require("darkmode-js"));
// @ts-ignore
var intro_ts_1 = __importDefault(require("./intro.ts"));
// @ts-ignore
var time_ts_1 = __importDefault(require("./time.ts"));
// Dark mode
var options = {
    label: '🌓',
    autoMatchOsTheme: true
};
var darkmode = new darkmode_js_1["default"](options);
darkmode.showWidget();
// JSON resume
var introCardText = document.querySelector('#json');
var screenWidth = document.body.clientWidth;
if (introCardText) {
    screenWidth > 768 ? introCardText.innerHTML = "<pre>" + intro_ts_1["default"]() + "</pre>" : introCardText.innerHTML = intro_ts_1["default"]();
}
// Time info
time_ts_1["default"].getTimeTitle();
time_ts_1["default"].progressOfYear();
},{"../assets/scss/style.scss":"assets/scss/style.scss","darkmode-js":"../node_modules/darkmode-js/lib/darkmode-js.js","./intro.ts":"js/intro.ts","./time.ts":"js/time.ts"}],"../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/js.ee83edca.map