...
var intro = function intro() {
  var myIntro = {
    ...
    Apply: 'FE / Full Stack',
    Skills: ['HTML(5)', 'CSS(3)', 'Javascript(ES6+)', 'Vue', 'React', 'Nodejs(Koa, express)', 'Python(3, flask)', 'Webpack / Parcel', 'D3.js / Echarts', 'MongoDB(mongoose)', 'PostgresSQL(...)', 'Git', 'Vim / VsCode', 'Docker']
  };
