...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=function(){return JSON.stringify({Name:"Yu Shifan","Phone / weChat":"18669086712",Education:"Dalian Neusoft University of Information",Employment:"EMQ (emqx.io) in Hangzhou",Apply:"FE / Full Stack",Skills:["HTML(5)","CSS(3)","Javascript(ES6+)","Vue(Buckets)","React(Buckets)","Nodejs(Koa, express)","Python(3, flask)","MongoDB(mongoose)","PostgresSQL(...)","Docker"]},null,2)};exports.default=e;
},{}],"QvaY":[function(require,module,exports) {
"use strict";require("../assets/scss/style.scss");var e=require("wired-elements"),r=require("./intro.js"),s=t(r);function t(e){return e&&e.__esModule?e:{default:e}}var u=document.querySelector("#json"),n=document.body.clientWidth;u.innerHTML=n>768?"<pre>"+(0,s.default)()+"</pre>":(0,s.default)();
},{"../assets/scss/style.scss":"LGxd","wired-elements":"MJfP","./intro.js":"by4F"}]},{},["QvaY"], null)
//# sourceMappingURL=/js.5f9726a9.map