...
"use strict";require("../assets/scss/style.scss");var e=require("darkmode-js"),r=a(e),t=require("wired-elements"),s=require("./intro.js"),d=a(s),i=require("./time.js"),u=a(i);function a(e){return e&&e.__esModule?e:{default:e}}var l=!0===window.matchMedia("(prefers-color-scheme: dark)").matches,o={label:"🌓"},n=new r.default(o);l&&n.toggle(),n.showWidget();var c=document.querySelector("#json"),f=document.body.clientWidth;c.innerHTML=f>768?"<pre>"+(0,d.default)()+"</pre>":(0,d.default)(),u.default.getTimeTitle(),u.default.progressOfYear();
},{"../assets/scss/style.scss":"LGxd","darkmode-js":"SagF","wired-elements":"MJfP","./intro.js":"by4F","./time.js":"ld0W"}]},{},["QvaY"], null)
//# sourceMappingURL=/js.36665bb1.map